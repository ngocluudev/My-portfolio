...
const HeroStyles = styled.div`
  ...
  .hero__heading {
    ...
    .hero__name {
      font-size: 7rem;
      font-family: 'Montserral SemiBold';
      color: var(--white);
    }
  }
  .hero__img {
      ...
      <div className="hero">
        <div className="container">
          <h1 className="hero__heading">
            ...
            <span className="hero__name">Luu Xuan Ngoc</span>
          </h1>
          ...
          <div className="hero__social">
            ...
            <div className="hero__social-text">
              <ul>
                <li>
                  <a
                    href="https://www.facebook.com/ngocluu2003/"
                    target="_blank"
                    rel=" noreferrer"
                  >
                    <FaFacebook />
                ...
                <li>
                  <a
                    href="https://github.com/ngocluudev"
                    target="_blank"
                    rel=" noreferrer"
                  >
                    <FaGithub />
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/luu-ngoc-655752232/"
                    target="_blank"
                    rel=" noreferrer"
                  >
                    <FaLinkedin />
